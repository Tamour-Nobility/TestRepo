...
@Component({
    selector: 'payment-by-carrier-report',
    templateUrl: './payment-by-carrier.component.html'
})
export class PaymentByCarrier implements OnInit {
    form: FormGroup;
    ...
    onSearch() {
        if (this.canSearch()) {
            ...
            this.API.PostData('/Report/PaymentByCarrier', this.request, (res) => {
    ...
    updateDatatable(data) {
        ...
        this.chRef.detectChanges();
        const table: any = $('.dataTablePaymentByCarrier');
        this.dataTable = table.DataTable({
            "data": this.mappedReportData,
            "columns": this.reportColumns,
            "scrollX": true,
            dom: this.datatableService.getDom(),
            buttons: this.datatableService.getExportButtons(['Payments by Carrier', this.request.dateFrom, this.request.dateTo]),
        });
    }
