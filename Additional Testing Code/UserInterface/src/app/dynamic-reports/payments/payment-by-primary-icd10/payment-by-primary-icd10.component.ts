...
@Component({
    selector: 'payment-by-primary-icd10-report',
    templateUrl: './payment-by-primary-icd10.component.html'
})
export class PaymentByPrimaryICD10 implements OnInit {
    form: FormGroup;
    ...
    onSearch() {
        if (this.canSearch()) {
            ...
            this.API.PostData('/Report/PaymentByPrimaryICD10', this.request, (res) => {
    ...
    updateDatatable(data) {
        ...
        this.chRef.detectChanges();
        const table: any = $('.dataTablePaymentByPrimaryICD10');
        this.dataTable = table.DataTable({
            "data": this.mappedReportData,
            "columns": this.reportColumns,
            "scrollX": true,
            dom: this.datatableService.getDom(),
            buttons: this.datatableService.getExportButtons(['Payments by Procedure Code', this.request.dateFrom, this.request.dateTo]),
        });
    }
